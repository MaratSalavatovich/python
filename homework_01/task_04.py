...
if revenue > costs:
    print(f"Фирма работает с прибылью. Ее величина: {profit}")
    print(
        f"Рентабельность выручки составила: {revenue / costs:.2f}")
    workers = int(input("Введите количество сотрудников фирмы: "))
    print(
        f"прибыль в расчете на одного сторудника сотавила: {profit / workers:.2f}")
elif revenue == costs:
